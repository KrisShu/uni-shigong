<template>
    <view :style="{ height: contentHeight + 'px' }" class="page-container">
        <view class="mine-cap">
            ...
            <!-- 跳转 -->
            <view class="jump-wrap" @click="jumpWebsite"> {{ $t('common.mine.jump') }} </view>
        </view>
...
<script setup lang="ts">
    ...
    const jumpWebsite = () => {
        window.open('http://www.jjexcavations.com.au', '_blank');
    };
</script>
<style lang="scss" scoped>
    .page-container {
        ...
        .mine-cap {
            ...
            .jump-wrap {
                height: 48rpx;
                background-color: rgba($color: #303133, $alpha: 0.6);
