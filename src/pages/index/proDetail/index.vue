<template>
    <view class="page project-detail-page" :style="{ height: contentHeight + 'px' }">
        <view class="top-fixed">
                ...
                <view class="pd-progress-card2">
                    ...
                    <view class="pd-progress-actions" v-show="projectDetails.isTeamLeader">
                        ...
                        <button
                            ...
                            :class="projectDetails.button_1 == 3 ? 'disabled' : ''"
                        >
                            {{ $t('staff.pro.start') }}
                        </button>
                        <!-- 更新进度 -->
                        <button
                            v-show="projectDetails.button_2 != 1"
                            @click="updateProgress"
                            class="pd-btn pd-btn--primary-light"
                            :class="projectDetails.button_2 == 3 ? 'disabled' : ''"
                        >
                            {{ $t('staff.pro.updateProgress') }}
                        </button>
                        <!-- 施工结束 -->
                        <button
                            v-show="projectDetails.button_3 != 1"
                            @click="buildCompleted"
                            class="pd-btn pd-btn--primary-light"
                            :class="projectDetails.button_3 == 3 ? 'disabled' : ''"
                        >
                            {{ $t('staff.pro.end') }}
                        </button>
                    </view>
            ...
            <scroll-view class="pd-tabs" scroll-x="true" :show-scrollbar="false" :enable-flex="true">
                <view
        ...
        <view class="bottom-area">
            ...
            <PdPunch
                v-show="projectDetails.status != 0 && activeTab === tabs[1].value"
        ...
        >
            <view class="build-completed-popup bottom-popup">
                ...
                <view class="build-completed-item">
                    ...
                    <ImageUploader ref="imageUploaderRef" v-model="END_imgs" @error="onError" />
                </view>
                <view class="build-completed-item">
