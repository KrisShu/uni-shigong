        ...
        <view class="bottom-area">
            <view class="form-content">
                <view class="tab-content1">
                    ...
                    <!-- 需求预算 -->
                    <view class="form-item">
                        <view class="label">{{ $t('cus.requirement.key_XQYS') }}/{{ $t('common.unit.money') }}</view>
                    ...
                    <!-- 期望开工日期 -->
                    <view class="form-item">
                        <view class="label">{{ $t('cus.requirement.key_QWKGRQ') }}</view>
...
<script lang="ts" setup>
    ...
    const save_requirement = async () => {
        console.log('保存需求', workDate.value);
