...
<script lang="ts" setup>
    ...
    const switchTab = (index: number) => {
        filterStore.set({ empIndexActiveTab: index, scrollTop: 0, empPageNo: 1 }); // 记录回到顶部
    ...
    const onLoadMore = () => {
        ...
        page.value++;
        filterStore.set({ empPageNo: page.value });
        fetchProjects();
    };
